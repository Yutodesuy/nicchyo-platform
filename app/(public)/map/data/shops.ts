...
const categories = [
  {
    name: '野菜・果物',
    icon: '🥬',
    products: ['レタス', 'トマト', 'にんじん', 'みかん', 'りんご', 'バナナ', 'ぶどう', 'いちご', 'なす', 'きゅうり']
  },
  {
    name: '食べ物・おやつ',
    icon: '🍙',
    products: ['おにぎり', 'お弁当', 'パン', 'お餅', 'お菓子', '焼き芋', 'たこ焼き', '団子', 'おはぎ', 'アイス']
  },
  {
    name: '刃物・工具',
    icon: '🔪',
  ...
  },
  {
    name: '植物・苗',
    icon: '🌱',
    products: ['トマト苗', 'ハーブ', '花の苗', '観葉植物', '多肉植物', '盆栽', '種', '球根', '肥料', '植木鉢']
  },
  {
    name: '手作り品',
    icon: '🎨',
    products: ['陶器', 'アクセサリー', '木工品', '染物', '編み物', '革製品', '刺繍', '絵画', '和紙', '竹細工']
  },
];
