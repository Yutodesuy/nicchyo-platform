...
export default function HamburgerMenu() {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleMenu}
        className="hamburger-menu-button fixed top-4 right-4 z-[10040] flex h-12 w-12 items-center justify-center rounded-lg bg-white/90 text-gray-700 shadow-md transition hover:bg-white hover:shadow-lg"
        aria-label="メニュー"
      >
